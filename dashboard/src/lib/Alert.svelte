...
{#if alert}
	<div
		in:fly={{ y: -200 }}
		out:fly={{ x: 800 }}
		class="ml-1 right-1 md:ml-0 border border-solid border-slate-200 dark:border-slate-200 bg-white dark:bg-accent w-[98%] md:w-1/4 shadow-xl fixed top-4 z-above-all md:right-4"
	>
